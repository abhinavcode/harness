...
func (_m *MockArtifactRepository) RestoreByImageNameAndRegistryID(ctx context.Context, regID int64, image string) error {
...
func (_m *MockArtifactRepository) RestoreByVersionAndImageName(ctx context.Context, image string, version string, regID int64) error {
...
func (_m *MockArtifactRepository) SoftDeleteByImageNameAndRegistryID(ctx context.Context, regID int64, image string) error {
	ret := _m.Called(ctx, regID, image)
...
func (_m *MockArtifactRepository) SoftDeleteByVersionAndImageName(ctx context.Context, image string, version string, regID int64) error {
	ret := _m.Called(ctx, image, version, regID)
