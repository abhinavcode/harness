...
// RegistryRepository_Restore_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Restore'
type RegistryRepository_Restore_Call struct {
	*mock.Call
}
...
//   - parentID int64
//   - name string
func (_e *RegistryRepository_Expecter) Restore(ctx interface{}, parentID interface{}, name interface{}) *RegistryRepository_Restore_Call {
	return &RegistryRepository_Restore_Call{Call: _e.mock.On("Restore", ctx, parentID, name)}
}

func (_c *RegistryRepository_Restore_Call) Run(run func(ctx context.Context, parentID int64, name string)) *RegistryRepository_Restore_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(string))
	})
	return _c
...
func (_c *RegistryRepository_Restore_Call) Return(err error) *RegistryRepository_Restore_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *RegistryRepository_Restore_Call) RunAndReturn(run func(context.Context, int64, string) error) *RegistryRepository_Restore_Call {
	_c.Call.Return(run)
	return _c
}
...
// RegistryRepository_SoftDelete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SoftDelete'
type RegistryRepository_SoftDelete_Call struct {
	*mock.Call
}
...
//   - parentID int64
//   - name string
func (_e *RegistryRepository_Expecter) SoftDelete(ctx interface{}, parentID interface{}, name interface{}) *RegistryRepository_SoftDelete_Call {
	return &RegistryRepository_SoftDelete_Call{Call: _e.mock.On("SoftDelete", ctx, parentID, name)}
}

func (_c *RegistryRepository_SoftDelete_Call) Run(run func(ctx context.Context, parentID int64, name string)) *RegistryRepository_SoftDelete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(string))
	})
	return _c
...
func (_c *RegistryRepository_SoftDelete_Call) Return(err error) *RegistryRepository_SoftDelete_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *RegistryRepository_SoftDelete_Call) RunAndReturn(run func(context.Context, int64, string) error) *RegistryRepository_SoftDelete_Call {
	_c.Call.Return(run)
	return _c
}
