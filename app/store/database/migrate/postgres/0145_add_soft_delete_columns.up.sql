...
ALTER TABLE registries 
    ...
    ADD COLUMN IF NOT EXISTS registry_deleted_by BIGINT;
...
ALTER TABLE images 
    ...
    ADD COLUMN IF NOT EXISTS image_deleted_by BIGINT;
...
ALTER TABLE artifacts 
    ...
    ADD COLUMN IF NOT EXISTS artifact_deleted_by BIGINT;
